...
// Tu código acá:
let name = document.querySelector('#createdBy').innerHTML = 'Aplicación creada por: Díaz Joaquín Eduardo';
...
function buildToDo(todo, index) {
  ...
  input.className = 'completeCheckbox'
  input.id = index;
  if (todo.complete) input.checked = true;
  toDoShell.appendChild(input);
...
function buildToDos(toDos) {
  // Tu código acá:
  let newArr = toDos.map(function(todo, index){
